...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 ">
        ...
        <form class="col-4" id="registerUserForm" method="POST">
            <div id="loginMessage"></div>
            <div class="mb-3">
                <label class="form-label">Name</label>
                <input type="text" class="form-control cu-input" name="userName">
            </div>
            <div class="mb-3">
            ...
            <input type="submit" value="Register" class="cu-button" name="registerUserFormSubmit">
    ...
    <script>
        ...
        $('#registerUserForm').on('submit', function(e) {
            ...
            formData.append("registerUserFormSubmit", true);
            $.ajax({
